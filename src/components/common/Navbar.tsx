        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 ">
            ...
            >
              ...
              <span className="text-2xl font-bold text-primary">DIMMER</span>
            </a>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-background border-t border-border">
              {navItems.map((item) => (
                <a
                  key={item.href}
                  onClick={() => scrollToSection(item.href)}
                  className="text-foreground/80 hover:text-primary block px-3 py-2 text-lg font-medium w-full text-center transition-colors duration-200"
                >
                  {item.label}
                </a>
              ))}
            ...
            <div>
              <a
                ...
                href="https://github.com/YBTopaz8/Dimmer-MAUI/releases"
                target="_blank"
                className="group rounded-full md:hidden flex items-center gap-2 bg-black text-white px-3 py-2 font-medium hover:bg-white hover:text-black border border-black transition-colors duration-200"
              >
